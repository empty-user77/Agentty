...
const STRINGS = {
  ...
  'auto.targets': ['Accounts to collect', '수집 대상 계정', '収集するアカウント', '要收集的账号'],
  'auto.targets.none': ['Add the accounts this automation collects.', '이 자동화가 수집할 계정을 추가하세요.', 'この自動化が収集するアカウントを追加してください。', '请添加此自动化要收集的账号。'],
